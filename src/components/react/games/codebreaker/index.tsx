	...
	return (
		<div className="mt-2 lg:mt-8">
			<div>
				...
				<div className="flex flex-row flex-wrap gap-1 lg:flex-row-reverse">
			...
			<div className="mx-auto mt-2 flex flex-col-reverse gap-2 lg:mx-0 lg:mt-8 lg:flex-row-reverse lg:gap-8">
				<div className="hidden grow lg:block"></div>
											...
											<Button
												classes={{
													button: cn('w-full border p-2 sm:p-3 md:p-4', {
														...
														'border-green-800/50 bg-green-900/25': col.clicked,
														// Victory
														'border-green-500/50 bg-green-500/25': victory,
														// Defeat
														'border-red-500/50 bg-red-500/25': defeat,
				...
				<Accordion label="FAQ" defaultOpen>
					<div className="space-y-4 bg-neutral-800/25 p-4 font-mono text-sm">
						...
						<p>
							...
							you make an incorrect guess, any partially solved vectors are
							reset.
						</p>
